...
def verify_output_dir_exists(directory: str, force_creation: bool = False, hint: str = "", raise_exception = True) -> bool:
...
def verify_input_dir_exists(directory: str, hint: str = "", raise_exception = True) -> bool:
