...
def download_and_compress_year_rept_l2(satellite: str, year: int) -> None:
    ...
    for month in range(1, 13):
        ...
        data_scraper.download_month_rbsp_rept_l2(satellite = satellite.upper(),
...
def download_and_compress_poes_metop(satellite: str) -> None:
    ...
    data_scraper.download_year_poes_after_2012(satid=satellite.lower(),
                                          make_dirs=True)

    data_compressor.compress_poes_after_2012(satellite=satellite.lower(),
                                  make_dirs=True)
